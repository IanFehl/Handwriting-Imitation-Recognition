...
class Model:
    ...
    def setupCTC(self, ctcIn3d):
        ...
        if self.decoderType == DecoderType.BestPath:
            ...
            corpus = open('C:/Users/Ian/PycharmProjects/Handwriting/data/corpus.txt').read()
    ...
    def setupTF(self):
        ...
        self.modelDir = 'C:/Users/Ian/PycharmProjects/Handwriting/model/' # + self.model_name + '/'
        self.trainLogDir = 'C:/Users/Ian/PycharmProjects/Handwriting/logs/train' + self.model_name
        self.testLogDir = 'C:/Users/Ian/PycharmProjects/Handwriting/logs/test' + self.model_name
    ...
    def trainBatch(self, batch, logging=True):
        ...
        rate = 0.01 if self.batchesTrained < 10 else (
            0.001 if self.batchesTrained < 10000 else 0.0005)  # decay learning rate
        if logging:
            (_, lossVal, summary, decoded) = self.sess.run([self.optimizer, self.loss, self.merged, self.decoder],
                                                           {self.inputImgs: batch.imgs, self.gtTexts: sparse,
    ...
    def save(self):
        "save model to file"
        self.snapID += 1
        self.saver.save(self.sess, 'C:/Users/Ian/PycharmProjects/Handwriting/model/snapshot', global_step=self.snapID)
